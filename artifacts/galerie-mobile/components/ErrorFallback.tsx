  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.message, { color: colors.mutedForeground, fontFamily: nativeTheme.fonts.regular }]}>
          Restartujte aplikaci pro pokračování.
        </Text>
        ...
        >
          <Text
            style={[styles.buttonText, { color: colors.primaryForeground, fontFamily: nativeTheme.fonts.medium }]}
          >
            Zkusit znovu
          </Text>
        </Pressable>
